...
//					break;
				case "out":
					...
					break;
				case "rank":
					handleRank(iossession, chater);
					break;
				case "introduce":
					handleIntroduce(iossession, chater);
					break;
				case "ensure_introduce":
					handleEnsureIntroduce(iossession, chater);
					break;
				case "punishment":
					handlePunishment(iossession, chater);
					break;
				case "ensure_punishment":
					handleEnsurePunishment(iossession, chater);
					break;
				case "talk":
					handleTalk(iossession, chater);
					break;
				case "ensure_warmgame":
					handleEnsureWarmGame(iossession, chater);
					break;
				default:
					break;
			}
